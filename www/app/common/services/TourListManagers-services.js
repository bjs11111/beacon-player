/* Services */
var tourListManagers = angular.module('tourListManagers', ['bleFilters', 'bleChannels', 'beaconAPIServices']);

tourListManagers.constant( "bleDeviceChannelConfig", {
	//events
	displayDeviceDeviceUpdates		: 'displayDeviceDeviceUpdates',
	displayDeviceDeviceUpdates 		: 'displayDeviceDeviceUpdates',
});

//bleDeviceChannel 
tourListManagers.factory('bleDeviceChannel', 
...
tourListManagers.constant( "bleDeviceServiceConfig", {
...
tourListManagers.factory('bleDeviceService', 
